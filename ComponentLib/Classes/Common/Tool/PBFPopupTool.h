...
//  weiCircle
//
//  Created by bran on 2017/6/28.
//  Copyright © 2017年 MAXC. All rights reserved.
...
@protocol PBFPopupDelegate;

@interface PBFPopupTool : NSObject

@property (nonatomic, weak) id <PBFPopupDelegate> _Nullable delegate;
...
@property (nonatomic, copy) void (^maskTouched)(PBFPopupTool *popupController);

// Should implement this block before the presenting. 应该在present前实现的block
@property (nonatomic, copy) void (^willPresent)(PBFPopupTool *popupController); // ContentView will present. 视图将要呈现

@property (nonatomic, copy) void (^didPresent)(PBFPopupTool *popupController); // ContentView Did present. 视图已经呈现

@property (nonatomic, copy) void (^willDismiss)(PBFPopupTool *popupController); // ContentView Will dismiss. 视图将要消失

@property (nonatomic, copy) void (^didDismiss)(PBFPopupTool *popupController); // ContentView Did dismiss. 视图已经消失
...
// 点击Mask是否 不消失popView
- (void)tapMaskNotDismiss:(BOOL)dismiss;
...
@protocol PBFPopupDelegate <NSObject>

@optional
// - Block对应的Delegate方法，block优先
- (void)popupControllerWillPresent:(nonnull PBFPopupTool *)popupController;
- (void)popupControllerDidPresent:(nonnull PBFPopupTool *)popupController;
- (void)popupControllerWillDismiss:(nonnull PBFPopupTool *)popupController;
- (void)popupControllerDidDismiss:(nonnull PBFPopupTool *)popupController;

@end

@interface NSObject (PBFPopupTool)
...
@property (nonatomic, strong) PBFPopupTool *sl_popupController;
